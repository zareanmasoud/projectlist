    ...
    authorFormIsValid(mode) {
        ...
        if (mode == "save") {
            ...
            if (this.state.author.id === undefined || this.state.author.id == null || this.state.author.id == '') {
                ...
                formIsValid = false;
            } else if (this.props.projects.find( crs => (crs.authorId == this.state.author.id))) {
                errors.firstName = "Can't delete an author that's referenced by a project.";
                formIsValid = false;
            }
        }
...
function mapStateToProps(state, ownProps) {
    const authorId = ownProps.params.id; // from the path '/project/:id'
